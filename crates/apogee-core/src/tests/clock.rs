...
//! - IERS Earth Orientation Parameters: https://hpiers.obspm.fr/iers/eop/
//!
//! TDB-TT relationship (~32.184s + periodic variations):
//! - IAU 2006 Resolution B3 (TDB redefinition, see IERS Conventions 2010 Ch. 1)
//!   https://iers-conventions.obspm.fr/content/tn36.pdf
//! - Fairhead, M. & Bretagnon, P. (1990), Astron. Astrophys. 229, 240-247
//!   https://ui.adsabs.harvard.edu/abs/1990A%26A...229..240F
//!
//! GPS-TAI offset (19s, constant since GPS epoch 1980-01-06):
//! - IS-GPS-200N, §3.3.1: https://www.gps.gov/sites/default/files/2025-07/IS-GPS-200N.pdf
//!
//! UT1-UTC test values (EOP C04):
//! - IERS EOP 08 C04: https://hpiers.obspm.fr/iers/eop/eopc04/
